<?php
    ...
    //Echo all the variables set
    echo ('---Data aquired from the form---<br><br>');
    ...
    //echo value and loop start msg
    echo ('<br>---Investment is passed to future_value---<br><br>');
    echo ('$future_value: ' . $future_value.'<br>');
    echo ('<br>---Loop Starts Here---<br><br>');
    for ($i = 1; $i <= $years; $i++) {
        $future_value += $future_value * ($interest_rate*0.01); // the error was here, int_rate wasn't converted to a decimal
        echo ('$i: ' . $i."<br>");
        echo ('$future_value: '.$future_value."<br>");
    }
    echo ('<br>---Loop Ends Here---<br>');
